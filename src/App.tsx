...
const DEFAULT_LANDING: Landing = {
  ...
  cta: { title: '¿Listo para tu próxima aventura?', copy: 'Reserva hoy y vive Costa Rica como nunca antes.<br/>Tu mejor historia comienza aquí.' },
  contact: { phone: '+506 8880-1234', email: 'info@capoycostarica.com', location: 'La Fortuna, Alajuela, Costa Rica' },
...
function renderLandingSection(key: string, landing: Landing) {
  switch (key) {
    ...
    case 'cta':
      return <section className="cta container" id="contacto"><div className="cta-copy"><div className="cta-logo">◒</div><div><h2>{landing.cta.title}</h2><p dangerouslySetInnerHTML={{ __html: landing.cta.copy }} /></div></div><div className="cta-actions"><a className="reserve-btn" href="#tours"><CalendarDays size={17}/>Reservar ahora</a><span>🟢 o escríbenos por WhatsApp</span></div></section>;
    default:
      return null;
  }
}
