  ...
  return <div className="site-shell">
    ...
    <main>
      <section className="section container" id="tours">
        ...
        <div className="tour-grid">{/* populated by PublicToursBridge from /api/public/tours */}</div>
      </section>
