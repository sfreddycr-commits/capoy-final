...
const ALLOWED_KEYS = new Set([
  ...
  'contact_phone','contact_email','contact_location','contact_whatsapp','contact_schedule','contact_address_extra','contact_instagram','contact_facebook','contact_tiktok',
  'cta_title','cta_copy','cta_whatsapp_label','footer_copy',
...
const LANDING_FLAT_DEFAULTS = {
  ...
  contact_whatsapp: '50688801234',
  contact_schedule: 'Lun a Dom · 7:00 a 21:00',
  contact_address_extra: '',
  contact_instagram: '',
  contact_facebook: '',
  contact_tiktok: '',
  cta_whatsapp_label: '🟢 o escríbenos por WhatsApp',
...
function buildLandingFromFlat(flat) {
  ...
  return {
    ...
    cta: { title: g('cta_title'), copy: g('cta_copy'), whatsappLabel: g('cta_whatsapp_label') },
    contact: {
      phone: g('contact_phone'),
      email: g('contact_email'),
      location: g('contact_location'),
      whatsapp: g('contact_whatsapp'),
      schedule: g('contact_schedule'),
      addressExtra: g('contact_address_extra'),
      instagram: g('contact_instagram'),
      facebook: g('contact_facebook'),
      tiktok: g('contact_tiktok'),
    },
